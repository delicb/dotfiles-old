# Starting point is this script: https://github.com/mathiasbynens/dotfiles/blob/master/.macos
...
defaults write NSGlobalDomain AppleLanguages -array "en-RS" "sr-Latin-RS" "sr-RS"
defaults write NSGlobalDomain AppleLocale -string "en_RS"
defaults write NSGlobalDomain AppleMeasurementUnits -string "Centimeters"
defaults write NSGlobalDomain AppleMetricUnits -bool true

# TODO: How to set Alt+space to switch between kayboard layouts?
